...
async def start(message: types.Message):
	await message.reply("Hi! I'm a bot that can upload video files. Just send me a video file and I'll do the rest.")
...
async def handle_directory_upload(message: types.Message):
	...
	video_files = [f for f in os.listdir(directory_name) if os.path.isfile(os.path.join(directory_name, f)) and f.endswith(".mp4")]
